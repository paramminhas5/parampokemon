...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "Career Quest — Playable Portfolio",
    locale: "en_US",
    firstName: "Param",
    lastName: "Minhas",
  },
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  const websiteJsonLd = {
    ...
    name: "Career Quest — Playable Portfolio",
    alternateName: ["Param Minhas Portfolio", "Param Minhas Resume", "Career Quest"],
    url: "https://paramminhas.com",
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      {
        "@type": "Question",
        name: "What is Career Quest?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Career Quest is a playable portfolio RPG that tells 15 years of Param Minhas's career as a Pokemon-style game. Built with Next.js 15, TypeScript, Canvas 2D, and Web Audio API. It features 10 explorable zones, 9 gym leader battles, a full evolution system, and synthesized audio with zero audio files.",
        },
      },
    ],
  };
  ...
  return (
    <html lang="en" dir="ltr">
      <head>
        <link
          href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Press+Start+2P&family=Space+Mono:ital,wght@0,400;0,700;1,400&display=swap"
          rel="stylesheet"
        />
