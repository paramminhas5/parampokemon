...
function CareerSection({ zones }: { zones: typeof ZONES }) {
  ...
  // Open card when it scrolls into view — never auto-close.
  ...
  // No-op: cards stay open once revealed by scroll.
