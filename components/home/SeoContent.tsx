    ...
    >
      <article itemScope itemType="https://schema.org/Person">
        ...
        <section>
          ...
          <h3>What is Career Quest?</h3>
          <p>Career Quest is a playable portfolio RPG that tells 15 years of Param Minhas&apos;s career as a Pokemon-style game. Built with Next.js 15, TypeScript, Canvas 2D, and Web Audio API. It features 10 explorable zones, 9 gym leader battles, full evolution system, and synthesized audio with zero audio files. Play it at paramminhas.com/play.</p>
        ...
        <nav>
          ...
          <ul>
            ...
            <li><a href="https://paramminhas.com/play">Play Career Quest — RPG game</a></li>
          </ul>
        </nav>
      </article>
    </div>
