...
const Z: Omit<Zone, "ox" | "oy">[] = [
  {
    ...
    w: 26, h: 20,
    building: { x: 9, y: 2, w: 8, h: 6, doorX: 4, color: "#d0d8e8", roof: "#b0382c" },
    sign: { x: 3, y: 12, text: "PALLET TOWN\nA portfolio you can walk through.\n\nSCROLL/ARROWS to walk.\nTAP to walk there.\nSPACE or A to talk.\nMAP to fast-travel anywhere." },
    badge: { x: 20, y: 12, id: "curiosity", label: "Starter Token", color: "#9ad6e8" },
    spawn: { x: 13, y: 14 },
    npcs: [
      { x: 4, y: 15, name: "Mom", role: "Pallet Town", kind: "mom", beat: "did",
      ...
      { x: 21, y: 6, name: "Prof. Iterate", role: "Pokémon Professor", kind: "professor", beat: "learned",
  ...
  },
  {
    ...
    w: 26, h: 20,
    building: { x: 9, y: 2, w: 8, h: 6, doorX: 4, color: "#e6c47a", roof: "#7a4d28" },
    sign: { x: 3, y: 13, text: "ORIGIN TOWN\nBuilder. Designer. Music producer.\nThe story starts here." },
    badge: { x: 20, y: 13, id: "vision", label: "Vision Badge", color: "#f5b78a" },
    npcs: [
      { x: 3, y: 9, name: "Param", role: "Builder · Designer · Director", kind: "trainer-m", beat: "did",
      ...
      { x: 22, y: 15, name: "The throughline", role: "What ties it together", kind: "celeb", beat: "learned",
  ...
  },
  {
    ...
    w: 26, h: 20,
    building: { x: 9, y: 2, w: 8, h: 6, doorX: 4, color: "#a8d39a", roof: "#3f7a3a" },
    sign: { x: 3, y: 13, text: "GRP MARKET\nIndia's first price-comparison engine.\nBuilt in college." },
    badge: { x: 20, y: 13, id: "ship", label: "Search Badge", color: "#a8d39a" },
    npcs: [
      { x: 3, y: 10, name: "GetRightPrice", role: "Founding team · 2010", kind: "trainer-m", beat: "did",
      ...
      { x: 22, y: 16, name: "First-mover lessons", role: "What it taught me", kind: "investor", beat: "learned",
  ...
  },
  {
    ...
    w: 26, h: 20,
    building: { x: 9, y: 2, w: 8, h: 6, doorX: 4, color: "#c47833", roof: "#5a2c0c" },
    sign: { x: 3, y: 13, text: "HAB DISTRICT\nBudget rentals. ₹1Cr revenue.\nZero VC money." },
    badge: { x: 20, y: 13, id: "ops", label: "Operator Badge", color: "#f6a268" },
    npcs: [
      { x: 4, y: 15, name: "Hab Housing", role: "Founder · 2012", kind: "trainer-m", beat: "did",
      ...
      { x: 22, y: 9, name: "What ₹1Cr taught me", role: "Bootstrapping", kind: "tenant", beat: "learned",
  ...
  },
  {
    ...
    w: 26, h: 20,
    building: { x: 9, y: 2, w: 8, h: 6, doorX: 4, color: "#4a6e9a", roof: "#1f3548" },
    sign: { x: 3, y: 13, text: "QUARTIC LAB\nBuilt AI before it was a category.\n2013 chatbot · Octo · Quartic.ai" },
    badge: { x: 20, y: 13, id: "ai", label: "Conversation Badge", color: "#9fe8ff" },
    npcs: [
      { x: 3, y: 13, name: "Octo → Quartic", role: "Founding team · 2013", kind: "engineer", beat: "did",
      ...
      { x: 22, y: 8, name: "Akshaya Aron", role: "Co-founder Octo · CEO Quartic.ai", kind: "trainer-f", beat: "did",
  ...
  },
  {
    ...
    w: 26, h: 20,
    building: { x: 9, y: 2, w: 8, h: 6, doorX: 4, color: "#9a6fc4", roof: "#3f2266" },
    sign: { x: 3, y: 13, text: "INVESTOPAD\nFamily office of Rohan & Arjun Malhotra.\nFund 0 from scratch." },
    badge: { x: 20, y: 13, id: "fund", label: "Capital Badge", color: "#f0c4ff" },
    npcs: [
      { x: 3, y: 9, name: "Investopad", role: "Growth & Tech Partner · Fund 0", kind: "investor", beat: "did",
      ...
      { x: 22, y: 16, name: "Portfolio", role: "Companies worked with", kind: "client", beat: "did",
  ...
  },
  {
    ...
    w: 26, h: 20,
    building: { x: 9, y: 2, w: 8, h: 6, doorX: 4, color: "#c0388c", roof: "#4a1240" },
    sign: { x: 3, y: 13, text: "SOLESEARCH MALL\nIndia's sneaker & streetwear platform.\n$795K raised · CNBC-TV18." },
    badge: { x: 20, y: 13, id: "ceo", label: "Culture Badge", color: "#ff9fd4" },
    npcs: [
      { x: 4, y: 15, name: "SoleSearch", role: "Co-founder & CEO · 2020-24", kind: "celeb", beat: "did",
      ...
      { x: 22, y: 9, name: "Prabal Baghla", role: "Co-founder · SoleSearch", kind: "trainer-m", beat: "learned",
  ...
  },
  {
    ...
    w: 26, h: 20,
    building: { x: 9, y: 2, w: 8, h: 6, doorX: 4, color: "#1a8c6e", roof: "#053d2c" },
    sign: { x: 3, y: 13, text: "FERE DISTRICT\nAutonomous AI agents.\n$1.3M raised." },
    badge: { x: 20, y: 13, id: "agent", label: "Autonomy Badge", color: "#00e8a0" },
    npcs: [
      { x: 3, y: 10, name: "Fere.ai", role: "AI × Crypto · 2024-25", kind: "engineer", beat: "did",
      ...
      { x: 22, y: 16, name: "Full circle", role: "What Fere taught me", kind: "investor", beat: "learned",
  ...
  },
  {
    ...
    w: 26, h: 20,
    building: { x: 9, y: 2, w: 8, h: 6, doorX: 4, color: "#c47844", roof: "#5a2c10" },
    sign: { x: 3, y: 13, text: "CATS CAN DANCE\nMusic label · Pet-forward brand.\nNo brief. No client." },
    badge: { x: 20, y: 13, id: "soul", label: "Soul Badge", color: "#ffd29a" },
    npcs: [
      { x: 4, y: 14, name: "Cats Can Dance", role: "Music label · Pet brand", kind: "client", beat: "did",
      ...
      { x: 22, y: 10, name: "A cat", role: "Studio resident", kind: "fan", beat: "did",
        quote: "Mrrrp." },
    ],
  ...
  },
  {
    ...
    w: 26, h: 20,
    building: { x: 9, y: 2, w: 8, h: 6, doorX: 4, color: "#4a8cc4", roof: "#1a3858" },
    sign: { x: 3, y: 13, text: "ITERATE HQ\nAI-native marketing agency.\nFifteen years pointed at one target." },
    badge: { x: 20, y: 13, id: "champion", label: "Champion Badge", color: "#7ce0ff" },
    npcs: [
      { x: 3, y: 10, name: "Iterate", role: "Founder · AI-native agency", kind: "engineer", beat: "did",
